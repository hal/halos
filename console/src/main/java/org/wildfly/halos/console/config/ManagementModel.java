...
import org.wildfly.halos.console.config.Version;
import org.wildfly.halos.console.dmr.ModelNode;

import static org.wildfly.halos.console.dmr.ModelDescriptionConstants.MANAGEMENT_MAJOR_VERSION;
import static org.wildfly.halos.console.dmr.ModelDescriptionConstants.MANAGEMENT_MICRO_VERSION;
import static org.wildfly.halos.console.dmr.ModelDescriptionConstants.MANAGEMENT_MINOR_VERSION;
...
public class ManagementModel {
    ...
    private static boolean ensureVersion(Version existing, Version expected) {
        return existing != Version.EMPTY_VERSION && existing.greaterThanOrEqualTo(expected);
    }
