...
public class Version implements Comparable<Version> {
     ...
     * <code>null</code> or
     * the empty string then <code>EMPTY_VERSION</code> will be returned.
    ...
    public Version(String version) {
        ...
        try {
            String[] parts = version.split("\\" + SEPARATOR);
     ...
     * is less than the other version's qualifier component (using
