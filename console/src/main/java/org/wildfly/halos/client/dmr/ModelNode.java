...
import static org.wildfly.halos.client.dmr.ModelDescriptionConstants.FAILURE_DESCRIPTION;
import static org.wildfly.halos.client.dmr.ModelDescriptionConstants.OUTCOME;
import static org.wildfly.halos.client.dmr.ModelDescriptionConstants.SUCCESS;
...
public class ModelNode implements Cloneable {
    ...
    /**
     * Prevent further modifications to this node and its sub-nodes. Note that copies of this node made after this
     * method call will not be protected.
     */
    public void protect() {
        if (!protect) {
            protect = true;
    ...
    /**
     * Get the value of this node as a {@code long}. Collection types will return the size of the collection for this
    ...
    /**
     * Get the value of this node as number. Collection types will return the size of the collection for this value.
    ...
    /**
     * Get the value as a string. This is the literal value of this model node. More than one node type may yield the
    ...
    /**
     * Get the value of this node as a {@code double}. Collection types will return the size of the collection for this
     * value. Other types may attempt a string conversion.
     *
    ...
    /**
     * Get the value of this node as an {@code double}. Collection types will return the size of the collection for this
     * value. Other types may attempt a string conversion.
     *
     * @param defVal the default value if no conversion is possible
     * @return the int value
    ...
    /**
     * Get the value of this node as a type, expressed using the {@code ModelType} enum. The string value of this node
     * must be convertible to a type.
     *
    ...
    /**
     * Get the value of this node as a {@code BigDecimal}. Collection types will return the size of the collection for
     * this value. Other types may attempt a string conversion.
     *
    ...
    /**
     * Get the value of this node as a {@code BigInteger}. Collection types will return the size of the collection for
     * this value. Other types may attempt a string conversion.
     *
    ...
    /**
     * Get the value of this node as a byte array. Strings and string-like values will return the UTF-8 encoding of the
     * string. Numerical values will return the byte representation of the number.
     *
     * @return the bytes
     * @throws IllegalArgumentException if no conversion is possible
     */
    ...
    /**
     * Get the value of this node as a property. Object values will return a property if there is exactly one property
     * in the object. List values will return a property if there are exactly two items in the list, and if the first is
    ...
    /**
     * Get the value of this node as a property list. Object values will return a list of properties representing each
     * key-value pair in the object. List values will return all the values of the list, failing if any of the values
     * are not convertible to a property value.
     *
    ...
    /**
     * Get the value of this node as {@code type}. This method simply delegates to the various {@code asXXX()} methods
    ...
    /**
     * Get the child of this node with the given name. If no such child exists, create it. If the node is undefined, it
     * will be initialized to be of type object.
     * <p>
    ...
    /**
     * Determine whether this node has a child with the given name. Property node types always contain exactly one value
     ...
     * corresponding to the mappings within the object. Other types will return an empty list.
     *
